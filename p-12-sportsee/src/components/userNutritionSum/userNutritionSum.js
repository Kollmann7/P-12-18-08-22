        ...
        <div className='nutrition-container'>
            <div className='container'>
                ...
                <div className='container-infos'>
                    <span><strong>{props.usernutritionsum.calorieCount} kCal</strong></span>
                    <span>Calories</span>
                </div>
            </div>
            <div className='container'>
                ...
                <div className='container-infos'>
                    <span><strong>{props.usernutritionsum.carbohydrateCount} g</strong></span>
                    <span>Proteines</span>
                </div>    
            </div>
            <div className='container'>
                ...
                <div className='container-infos'>
                    <span><strong>{props.usernutritionsum.lipidCount} g</strong></span>
                    <span>Glucides</span>
                </div>    
            </div>
            <div className='container'>
                ...
                <div className='container-infos'>
                    <span><strong>{props.usernutritionsum.proteinCount} g</strong></span>
                    <span>Lipides</span>
                </div>    
            </div>
        </div>
